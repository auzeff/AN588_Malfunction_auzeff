...
> YM: I like that you are using print() instead of warning() for your warning messages! When I used warning(), it would sometimes mess with my output in RStudio.
------------------------------------------------------------------------
...
```
> YM: Using complete.cases() to remove NAs is so much cleaner than what I did with na.omit(). Thanks for showing me this approach!
...
p
```
> YM: I like how you built the plot step by step, adding each element on a new line. Makes it super clear what each part does!
------------------------------------------------------------------------
...
> YM: For the 800g brain size prediction, I totally agree with your assessment that it's not reliable. I got similar results and was also skeptical since it's way outside our data range.
------------------------------------------------------------------------
...
> YM: I feel you on challenge #1! I also spent way too much time just figuring out what the function was supposed to do. Your final implementation is really clean though!